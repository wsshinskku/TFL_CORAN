...
- Added full-scale and smoke profiles with documented simulator settings.
...
- Added reproducibility, experiment settings, migration, citation, and third-party licensing documentation.
